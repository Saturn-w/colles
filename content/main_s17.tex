...
\fancyhead[L]{Semaine 17 - Espaces préhilbertiens - euclidiens} % En-tête à gauche
...
\title{Semaine 17 - Espaces préhilbertiens - euclidiens\\
\large PSI}
\date{}
\maketitle
\tableofcontents

\clearpage \input{s17/ex1}
\clearpage \input{s17/ex2}
\clearpage \input{s17/ex3}
\clearpage \input{s17/ex4}
\clearpage \input{s17/ex5}
\clearpage \input{s17/ex6}
