...
\fancyhead[L]{Semaine 14 - Variables aléatoires discrètes} % En-tête à gauche
...
\title{Semaine 14 - Variables aléatoires discrètes\\
\large PSI}
\date{}
\maketitle
\tableofcontents

\clearpage \input{s14/ex1}
\clearpage \input{s14/ex2}
\clearpage \input{s14/ex3}
\clearpage \input{s14/ex4}
\clearpage \input{s14/ex5}
