...
% En-têtes avec fancyhdr
\usepackage{fancyhdr}
\pagestyle{fancy}
\fancyhf{} % Efface tous les en-têtes et pieds de page
\fancyhead[L]{Semaine 1 - Algèbre linéaire - première partie}
\fancyfoot[C]{\thepage} % Numéro de page au centre en bas
\renewcommand{\headrulewidth}{0pt} % Pas de ligne de séparation
...
\title{Semaine 1 - Algèbre linéaire - première partie\\
\large PSI}
\date{}
\maketitle
\tableofcontents
...
\clearpage \input{s1/ex1}
\clearpage \input{s1/ex2}
\clearpage \input{s1/ex3}
\clearpage \input{s1/ex4}
\clearpage \input{s1/ex5}
\clearpage \input{s1/ex6}
\clearpage \input{s1/ex7}
\clearpage \input{s1/ex8}
\clearpage \input{s1/ex9}
