...
\fancyhead[L]{Semaine 18 - Intégration sur un intervalle quelconque} % En-tête à gauche
...
\title{Semaine 18 - Intégration sur un intervalle quelconque\\
\large PSI}
\date{}
\maketitle
\tableofcontents

\clearpage \input{s18/ex1}
\clearpage \input{s18/ex2}
\clearpage \input{s18/ex3}
\clearpage \input{s18/ex4}
\clearpage \input{s18/ex5}
\clearpage \input{s18/ex6}
