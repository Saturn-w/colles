...
\fancyhead[L]{Semaine 16 - Espaces préhilbertiens - euclidiens} % En-tête à gauche
...
\title{Semaine 16 - Espaces préhilbertiens - euclidiens\\
\large PSI}
\date{}
\maketitle
\tableofcontents

\clearpage \input{s16/ex1}
\clearpage \input{s16/ex2}
\clearpage \input{s16/ex3}
\clearpage \input{s16/ex4}
\clearpage \input{s16/ex5}
