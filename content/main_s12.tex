...
\fancyhead[L]{Semaine 12 - Séries entières} % En-tête à gauche
...
\title{Semaine 12 - Séries entières\\
\large PSI}
\date{}
\maketitle
\tableofcontents

\clearpage \input{s12/ex1}
\clearpage \input{s12/ex2}
\clearpage \input{s12/ex3}
\clearpage \input{s12/ex4}
\clearpage \input{s12/ex5}
\clearpage \input{s12/ex6}
\clearpage \input{s12/ex7}
