...
\fancyhead[L]{Semaine 19 - Équations Différentielles} % En-tête à gauche
...
\title{Semaine 19 - Équations Différentielles\\
\large PSI}
\date{}
\maketitle
\tableofcontents

\clearpage \input{s19/ex1}
\clearpage \input{s19/ex2}
\clearpage \input{s19/ex3}
\clearpage \input{s19/ex4}
\clearpage \input{s19/ex5}
\clearpage \input{s19/ex6}
