...
\fancyhead[L]{Semaine 15 - Variables aléatoires discrètes} % En-tête à gauche
...
\clearpage \input{s15/ex1}
\clearpage \input{s15/ex2}
\clearpage \input{s15/ex3}
\clearpage \input{s15/ex4}
\clearpage \input{s15/ex5}
\clearpage \input{s15/ex6}
