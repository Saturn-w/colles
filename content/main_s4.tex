...
\fancyhead[L]{Semaine 4 - Algèbre linéaire - Seconde partie} % En-tête à gauche
...
\title{Semaine 4 - Algèbre linéaire - Seconde partie\\
\large PSI}
\date{}
\maketitle
\tableofcontents
...
\clearpage \input{s4/ex1}
\clearpage \input{s4/ex2}
\clearpage \input{s4/ex3}
\clearpage \input{s4/ex4}
\clearpage \input{s4/ex5}
