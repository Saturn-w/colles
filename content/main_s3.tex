...
\fancyhead[L]{Semaine 3 - Algèbre linéaire - Seconde partie} % En-tête à gauche
...
\title{Semaine 3 - Algèbre linéaire - Seconde partie\\
\large PSI}
\date{}
\maketitle
\tableofcontents

\clearpage \input{s3/ex1}
\clearpage \input{s3/ex2}
\clearpage \input{s3/ex3}
\clearpage \input{s3/ex4}
